...
-The input directory should be the launcher directory inside the Imperator directory, either passed as a paramter or using the contents of the config.txt file.
